...
\end{equation}
Without loss of generality we assume the weights $w_{ij}$ add up to one.
...
$$
Remember that in the context of Sammon Mapping the least squares monotone regression has to be done on the
squared distances.
