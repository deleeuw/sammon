...
$$
\sqrt{d_{ij}(X)}-\sqrt{\delta_{ij}}\approx\frac{1}{\sqrt{\delta_{ij}}}(d_{ij}(X)-\delta_{ij})
$$
and thus
$$
\sum w_{ij}(\sqrt{\delta_{ij}}-\sqrt{d_{ij}(X)})^2\approx\sum w_{ij}\frac{(\delta_{ij}-d_{ij}(X))^2}{\delta_{ij}}
$$
More robust.
